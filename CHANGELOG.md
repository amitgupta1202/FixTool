...
- Latency settings, panel, grid column, thresholds and correlation tags are otherwise unchanged. The scenario runner's per-step latency and run records still use the engine's capture clock.
