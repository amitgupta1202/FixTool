...
class SearchResultsPaneTest {
    ...
    @Test
    fun testPinSearchResultsOpensPane() =
        runBlocking {
    ...
    @Test
    fun testCloseSearchResultsPane() =
        runBlocking {
    ...
    @Test
    fun testPinnedResultsPersistAfterDialogClose() =
        runBlocking {
    ...
    @Test
    fun testNavigateToSearchResultFromPane() =
        runBlocking {
            // Create two sessions
    ...
    @Test
    fun testSearchResultsPaneShowsSessionUsername() =
        runBlocking {
    ...
    @Test
    fun testSearchResultsIncludeMetadata() =
        runBlocking {
            // Create session
            val session = viewModel.createSessionForTest("Test Session")
